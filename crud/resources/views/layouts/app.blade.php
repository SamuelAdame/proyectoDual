  ...
  <body class="bg-gray-100 text-gray-800">
    <nav class="flex py-5 bg-indigo-500 text-white">
      <div class="w-1/2 px-12 mr-auto">
          <p class="text-2x1 font-bold">Crud</p>
      </div>
      <ul class="w-1/2 px-16 ml-auto flex justify-end pt-1">
        @if(auth()->check())
          ...
          <li>
            <a href="{{route('login.destroy')}}" class="font-bold py-2 px-4 rounded-md bg-red-500 hover:bg-red-600 hover:text-indigo-700">Cerrar Sesión</a>
          </li> 
          <li>  
          ...
          <li>
            <a href="{{route('productos.crear')}}" class="text-white rounded px-4 pt-1 h-10 bg-blue-500
            font-semibold mx-2 hover:bg-blue">Crear</a>
          </li>
          @else
          <li class="mx-6">
